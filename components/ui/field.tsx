...
import { type ComponentProps, ReactNode, useMemo } from 'react'
...
const FieldDescription = ({ className, ...props }: ComponentProps<'p'>) => {
    return (
        <p
            ...
            className={cn(
                'text-secondary text-sm leading-normal font-normal group-has-data-[orientation=horizontal]/field:text-balance',
